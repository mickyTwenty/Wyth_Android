...
public class DirectionConverter {
    ...
    public static PolylineOptions createPolyline(Context context, ArrayList<LatLng> locationList, int width, int color) {
        PolylineOptions rectLine = new PolylineOptions().width(dpToPx(context, width)).color(color).geodesic(true).startCap(new SquareCap()).endCap(new SquareCap()).jointType(ROUND);
