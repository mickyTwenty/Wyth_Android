...
public class VerificationDialog extends Dialog {
    ...
    private VerificationDialog(@NonNull Context context, int themeResId) {
    ...
    private void initUi() {
        ...
        View dialogView = li.inflate(R.layout.dialog_verification, null, false);
    ...
    public static class Builder {
        ...
        public Builder(Context context, @StyleRes int styleRes) {
            dialog = new VerificationDialog(context, styleRes);
        }
        ...
        public Builder setPositiveButton(String str, VerificationDialogInterface iface) {
        ...
        public Builder setNegativeButton(String str, VerificationDialogInterface iface) {
            dialog.txtNegative.setText(str);
...
//            dialog.txtMessage.setTextSize(StaticMethods.convertSpToPixels(16, dialog.context));
        ...
        public VerificationDialog show() {
            if (!isFieldShown)
        ...
        public Builder setResendListener(VerificationDialogInterface listener) {
            dialog.btnResend.setOnClickListener(v -> listener.onSubmit(dialog));
            return this;
        }
    }

    public interface VerificationDialogInterface {
        void onSubmit(VerificationDialog dialog);
    }
}
