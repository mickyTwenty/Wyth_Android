...
public class SeatUsDialog extends Dialog {
    ...
    private SeatUsDialog(@NonNull Context context, int themeResId) {
        super(context, R.style.BounceDialog);
        this.context = context;
        initUi();
    }

    public SeatUsDialog(@NonNull Context context) {
        super(context);
        this.context = context;
        initUi();
    }
    ...
    private void initUi() {
        ...
        View dialogView = li.inflate(R.layout.dialog_seatus, null, false);
    ...
    public static class Builder {
        ...
        public Builder(Context context, @StyleRes int styleRes) {
            dialog = new SeatUsDialog(context, styleRes);
        }
...
//            dialog.txtMessage.setTextSize(StaticMethods.convertSpToPixels(16, dialog.context));
    ...
    public interface SeatUsDialogInterface {
        void onSubmit(SeatUsDialog dialog);
    }
}
