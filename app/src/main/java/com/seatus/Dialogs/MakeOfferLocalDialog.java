...
public class MakeOfferLocalDialog extends BaseOfferDialog {
    ...
    private MakeOfferLocalDialog(@NonNull Context context, int themeResId) {
    ...
    public MakeOfferLocalDialog(@NonNull Context context) {
        super(context);
        this.context = context;
        initUi();
    }
    ...
    public static class Builder {
        ...
        MakeOfferLocalDialog dialog;
        boolean isFieldShown;

        public Builder(Context context, @StyleRes int styleRes) {
            dialog = new MakeOfferLocalDialog(context, styleRes);
        }
...
//            dialog.txtMessage.setTextSize(StaticMethods.convertSpToPixels(16, dialog.context));
        ...
        public MakeOfferLocalDialog show() {
            dialog.show();
            return dialog;
        }
    ...
    public interface OfferInterface {
        void onSubmit(MakeOfferLocalDialog dialog, Float price, Integer bagsOrSeats, Integer returnSeats);
    }
}
