...
public class PassengersOffersAdapter extends FirestoreRecyclerAdapter<OfferItem, PassengerOfferHolder> {
    private final OnOfferAcceptInterface iface;
    /**
    ...
    public PassengersOffersAdapter(Context context, UserItem userItem, FirestoreRecyclerOptions options, OnOfferAcceptInterface iface) {
        super(options);
