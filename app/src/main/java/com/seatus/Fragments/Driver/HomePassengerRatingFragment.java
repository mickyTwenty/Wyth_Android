...
public class HomePassengerRatingFragment extends BaseFragment {
    ...
    public static HomePassengerRatingFragment newInstance(ArrayList<PendingRatingItem.Data> list) {
        HomePassengerRatingFragment fragment = new HomePassengerRatingFragment();
    ...
    public void inits() {
        ...
        mAdp = new EfficientRecyclerAdapter(R.layout.item_passenger_home_rating, DriverRatingHolder.class, mList);
    ...
    private void ratePassengers(String list) {
        getActivityViewModel().ratePassengers(list).observe(this, webResponseResource -> {
